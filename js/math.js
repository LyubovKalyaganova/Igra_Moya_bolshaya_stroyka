  ...
  var COUNT_TASKS = [
    {
      ...
      visual: '⭐',
      voice: 'Посмотри. Сколько звёздочек? Если одна — нажми цифру один.',
    ...
    },
    {
      ...
      voice: 'Посчитай самосвалы. Один, два, три. Сколько всего?',
    ...
    },
    {
      ...
      prompt: 'Сколько звёзд?',
      visual: '⭐⭐⭐⭐',
      voice: 'Посчитай звёздочки. Один, два, три, четыре. Сколько их?',
