  ...
  var LEVELS = [
    {
      ...
      hintMath: 'Поиграй в весёлые задания.',
      voiceMath: 'Давай поиграем! Посчитай, собери пазл и найди тень. Я рядом!',
      ...
      rewardMathTitle: 'Ты умница!',
      rewardMathText: 'Все весёлые задания выполнены!',
      pourTarget: 3,
      wallTarget: 5,
      finishTarget: 5,
      gradeTarget: 3,
